<div class="library">
    <div class="articles_library">
        ...
        <div class="card_all">
            ...
            <div class="card_library">
                <div class="card">
                    <img src="images\BrushCalligraphyAlphabet.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="font-weight:800;">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of
                            the card's content.</p>
                        <a href="brushcalligraphy.php" class="btn btn-primary">Go somewhere</a>
                        <button class="button_heart"><i class="bi bi-star"></i></button>
            ...
            <div class="card_library">
                <div class="card">
                    <img src="images\BasicCalligraphy.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="font-weight:800;">Card title</h5>
                        <p class="card-text">The Basic Calligraphy Strokes Guide (+FREE Worksheets)</p>
                        <a href="basiccalligraphy.php" class="btn btn-primary">Go somewhere</a>
                        <button class="button_heart"><i class="bi bi-star"></i></button>
                    </div>
                </div>
            </div>
            <div class="card_library">
                <div class="card">
                    <img src="images\10BestCalligraphyBooks.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="font-weight:800;">Card title</h5>
                        <p class="card-text">10 Best Calligraphy Books For Beginners</p>
                        <a href="10BestCalligraphyBooks.php" class="btn btn-primary">Go somewhere</a>
                        <button class="button_heart"><i class="bi bi-star"></i></button>
            ...
            <div class="card_library">
                <div class="card">
                    <img src="images\25BestHandwriting.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="font-weight:800;">Card title</h5>
                        <p class="card-text">25 Best Handwriting Fonts For A Personal Touch</p>
                        <a href="25BestHandwriting.php" class="btn btn-primary">Go somewhere</a>
                        <button class="button_heart"><i class="bi bi-star"></i></button>
