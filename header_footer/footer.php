<div class="footer">
    <div class="all_footer">
        <div class="foot about_footer">
            <p><i><h6>  Learn calligraphy with me</h6></i></p>
        </div>
    <div class="foot category_footer">
        <h6>CATEGORY</h6>
        <p><a href="/"><i class="bi bi-chevron-right"></i><b>Home</b></a></p>
    ...
    <div class="foot contact_footer">
        ...
        Mail: hotrocalligraphy@gmail.com
        </p>
    ...
    <div class="end_footer">
        <p>&copy; 2024 <b>QuickCalligraphy</b>. All rights reserved.</p>
    </div>
</div>
